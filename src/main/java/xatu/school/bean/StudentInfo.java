...
public class StudentInfo {
    ...
    public static final String COLUMN_XIBU = "xibu";// 系别
    ...
    public StudentInfo(String name, String xibu, String zhuanye, String xingbie, String banji, String xuehao, String shengri) {
        this.name = name;
        this.xibu = xibu;
