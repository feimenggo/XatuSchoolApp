...
public class EvaluateInfo {
    ...
    // 教学质量评价 表单单选标题
    public static String[] formRadioTitles = new String[]{"你认为教师教学态度是否认真负责？", "教师讲课是否激发了你对学习本课程的兴趣？ ", "你认为教师的教学方法、教学手段是否有助于你对课程的学习？", "你认为本课程的组织、时间利用是否合适？ ", "你认为课堂信息量是否合适？ ", "你认为教师是否善于引导学生积极思考，师生互动好？ ", "你认为教师是否注意维护课堂纪律，课堂气氛利于学习？", "你是否认为教师对讲授内容熟练、不照本宣科？ ", "你对教师在课堂和课后对你提供课程方面的帮助是否满意？ ", "你对本门课程的总体教学状况评价怎样？ "};
